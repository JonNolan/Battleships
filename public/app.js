document.addEventListener('DOMContentLoaded', () => {
  ...
  function checkForWins() {
    ...
    if (cpuDestroyerCount === 2) {
      infoDisplay.innerHTML = 'The computer sunk the user\'s destroyer!'
      cpuDestroyerCount = 10
    }
    if (cpuSubmarineCount === 3) {
      infoDisplay.innerHTML = 'The computer sunk the user\'s submarine!'
      cpuSubmarineCount = 10
    }
    if (cpuCruiserCount === 3) {
      infoDisplay.innerHTML = 'The computer sunk the user\'s cruiser!'
      cpuCruiserCount = 10
    }
    if (cpuBattleshipCount === 4) {
      infoDisplay.innerHTML = 'The computer sunk the user\'s battleship!'
      cpuBattleshipCount = 10
    }
    if (cpuCarrierCount === 5) {
      infoDisplay.innerHTML = 'The computer sunk the user\'s carrier!'
      cpuCarrierCount = 10
    }
