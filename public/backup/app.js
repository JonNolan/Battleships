document.addEventListener('DOMContentLoaded', () => {
  ...
  function initializeSquaresModel() {
  ...
  function populatePossibleMoves() {
    $.getJSON('/getDBTable', function(data) {
      let size = data.length
      for (i = 0; i < size; i++) {
        possibleMovesModel.push(data[i])
      }
  ...
  function populateTargets() {
    for (i = 0; i < squaresModel.length; i++) {
  ...
  function populateHighTargets() {
    ...
    for (i = 0; i < 81; i++) {
      let successRate = possibleMovesModel[i].dSuccessful / possibleMovesModel[i].dTotal
    ...
    for (i = 0; i < possibleTargetsModel.length; i++) {
      for (j = 0; j < mostSuccessfulClasses.length; j++) {
